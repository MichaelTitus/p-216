...
def generate_radar_blueprint(blueprint_library):
    ...
    #write code here   
    radar_blueprint.set_attribute('horizontal_fov', str(80))
    radar_blueprint.set_attribute('vertical_fov', str(80))
    radar_blueprint.set_attribute('points_per_second', str(3500))
    radar_blueprint.set_attribute('rotation_frequency', str(35))
...
try:
    ...
    def _Radar_callback(radar_data):
        for detection in radar_data:
            #write code here
            final_veloctiy=detection.velocity
            initial_velocity=0.5
            time=1
            acceleration=(-(final_veloctiy-initial_velocity))/time
            print(acceleration)
